...
```txt
https://weme-ui.github.io/schema/v2/registry.schema.json#/properties/items/items/properties/cssVariables/additionalProperties/anyOf/0/additionalProperties
```
