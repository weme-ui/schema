...
// Template
export const TEMPLATE_SCHEMA_URL = `${SCHEMA_BASE_URL}/${SCHEMA_VERSION}/template.schema.json`
export const TEMPLATE_INDEX_URL = `${SCHEMA_BASE_URL}/${SCHEMA_VERSION}/template-index.schema.json`
