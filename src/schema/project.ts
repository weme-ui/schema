...
const projectPathsSchema = z.object({
  components: z.string(),
...
const projectUnoCSSSchema = z.object({
...
export const projectSchema = z.object({
  ...
  unocss: projectUnoCSSSchema,
})

export type ProjectSchema = z.infer<typeof projectSchema>
export type ProjectPathsSchema = z.infer<typeof projectPathsSchema>
export type ProjectUnoCSSSchema = z.infer<typeof projectUnoCSSSchema>
