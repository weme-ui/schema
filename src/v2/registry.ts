...
export const RegistryName = z
  .templateLiteral([z.string().lowercase().trim(), z.literal('/'), z.string().lowercase().trim()])
  .meta({
    title: 'Registry Name',
 ...
 * Registry item scope
 */
export const RegistryItemScope = z
  .enum(['init', 'component', 'layout', 'theme', 'page', 'plugin'])
  .meta({
 ...
 */
export const RegistryItemFileType = z
 ...
 */
export const RegistryItemFile = z
...
export const RegistryItem = z.object({
   ...
   */
  cssVariables: z
    .record(z.string().trim(), z.record(z.string().trim(), z.string().trim()).or(z.string().trim()))
    .optional()
    .meta({
 ...
 */
export const RegistrySchemaV2 = z
  .object({
    /**
     * Schema URL.
     *
